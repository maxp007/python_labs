...
class PageView(View):
    ...
    def get(self, request, id):
        ...
        # lowercase для названий картинок
        ...
        customers = []
        # Перепроверить ->
        # orders = OrderModel.objects.filter(computer_id__exact=int(id))
...
# Убрать, стили перенести на AuthorizeDjango
